...
/*  
  Using the WebDAV server:
    ...
    - Map Network Drive:
      ...
      - Click on the link âConnect to a web site that you can use to store your documents and pictures.â
      - Click âNextâ and then âChoose a custom network location.â
